    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CUSTOMER', 'Khách hàng'), ('INVENTORY_STAFF', 'Nhân viên quản lý kho'), ('SALES_STAFF', 'Nhân viên bán hàng'), ('MANAGER', 'Quản lý cửa hàng')], default='CUSTOMER', max_length=20, verbose_name='Vai trò')),
